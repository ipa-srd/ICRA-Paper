...
The model works well in this application and can be used to follow people, and evade incoming persons. \todo{blah blah blah, will say more once the training is finally f...ing finished}